# wall-frame-joint Specification

## Purpose

The frames and walls stacked into one closed standing buffer: guide-wall tongues in frame grooves, side walls in their slots, and the stack under gravity.
